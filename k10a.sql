...
CREATE TABLE IF NOT EXISTS `kitap` (
  ...
  `yazar sira` int(11) NOT NULL DEFAULT 0,
  `tur sira` int(11) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `odunc` (
  `sira` int(11) NOT NULL AUTO_INCREMENT,
  `ogrenci sira` int(11) DEFAULT NULL,
  `kitap sira` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ogrenci` (
  ...
  `sinif sira` int(11) DEFAULT NULL,
  `okul no` smallint(6) DEFAULT NULL,
  PRIMARY KEY (`sira`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS `yazar` (
  `sira` int(11) NOT NULL AUTO_INCREMENT,
  `Sütun 2` varchar(30) NOT NULL,
  `Sütun 3` varchar(30) NOT NULL,
